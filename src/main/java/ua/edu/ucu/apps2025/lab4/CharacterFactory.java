...
public class CharacterFactory {
    ...
    public static Character createRandomCharacterWithLibReflections() throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        Reflections reflections = new Reflections("ua.edu.ucu.apps2025.lab4");
